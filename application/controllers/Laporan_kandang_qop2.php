...
class Laporan_kandang_qop2 extends CI_Controller {
	...
	function index(){
		...
		$this->template->load('administrator/template','administrator/mod_laporan_kandang_qop/view_laporan_kandang_qop2',$data);
	}
