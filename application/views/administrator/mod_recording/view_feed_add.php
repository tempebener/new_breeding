...
</style> <?php echo form_open_multipart('recording/save_pakan_recording');?>
...
?>
              ...
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Daily Report Feed</h3>
                </div>
              <div class='box-body'><div class='col-md-6 no-border'>
...
<tbody id="tx">
  ...
  <tr>
                      <td class="tnomor"></td>
                      <td><select  id='a'  class='select2 form-control' onchange=\"changeValue(this.value)\"  autofocus>
                    <option value=''>- Pilih -</option>
                    <?php
                    $page = '1';
										$sql = "select * from tb_stock where id_chickin  = '$ax->id_chickin' and id_material_stock = '1'";
                    ...
                    <option value="<?php echo $x->id_stock;?>">
                      ...
                      <td><input class='form-control plus5' id='b' type='number' min='0.00' step="0.01"></td>
                      <td><input class='form-control plus6' id='e' type='number' min='0.00' step="0.01"></td>
                      <td><input class='form-control plusresult2' type='number' id='c' min='0.00' step="0.01"> </td>
          ...
          <a href='' class='hide text-danger b2 btn btn-danger'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>
            ...
            <?php
           						  $sql = "select * from tb_pakan_detail a join tb_stock b on b.id_stock = a.id_stock where a.id_jadwal = '$ax->id_jadwal'";
                                     ...
                                     <td class="tnomor"><?= isset($no) ? ++$no : $no=1 ?> </td>
                                     <td>
           						  <input type='hidden' name='aa[]' value='<?php echo $xx->id_stock;?>'/><input type='hidden' name='bb[]' value='<?php echo $xx->jml_jantan;?>'/><input type='hidden' name='ee[]'  value='<?php echo $xx->jml_betina;?>'/><input type='hidden' name='cc[]' class='jml' value='<?php echo $xx->jml_pakan;?>'/>
                          ...
                          <?php
                              ...
                              foreach($a as $x) {
                                ?>
                                     ...
                                     <td><input class='form-control' readonly='on'  id='b' type='number' min='0.00' step="0.01" value='<?php echo $xx->jml_jantan;?>'></td>
                                     <td><input class='form-control' readonly='on' id='e' type='number' min='0.00' step="0.01" value='<?php echo $xx->jml_betina;?>'></td>
                                     <td><input class='form-control' readonly='on' id='c' type='number' min='0.00' step="0.01" value='<?php echo $xx->jml_pakan;?>'   > </td>
                                     <td>
