...
echo form_open_multipart('recording/add_bw',$attributes);
    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Body Weight</h3>
                </div>
              <div class='box-body'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart('recording/add_bw',$attributes);
          echo "<div class='col-md-12'>
                ...
                <div class='col-md-6'>
                  <div class='form-group'>
                    ...
                    <input type='text' class='form-control' name='kandang' maxlength='40' readonly value='$detail[no_chickin]'></input>
                  </div>

                  <div class='form-group'>
                    <label><strong>Kandang</strong></label>
                    <input type='hidden' name='id_kandang' value='$detail[id_kandang]'>
                    <input type='text' class='form-control' name='kandang' maxlength='40' readonly value='$detail[kandang]'></input>
                  </div>
                </div>
                ...
                <div class='col-md-6'>
                  <div class='form-group'>
                    ...
                    <input type='text' class='form-control' name='kandang' maxlength='40' readonly value='$detail[pembuatan]'></input>
                  </div>

                  <div class='form-group'>
                    <label><strong>Plant</strong></label>
                    <input type='hidden' name='id_plant' value='$detail[id_plant]'>
                    <input type='text' class='form-control' name='kandang' maxlength='40' readonly value='$detail[plant]'></input>
                  </div>
                </div>
                  ...
                  <div><h3><u><b> <font color='blue'>BW</font><b></u></h3></div>
                    ...
                    <tbody>
                      ...
                      <tr><th width='120px' scope='row'>Jantan</th>    <td class='input-group'><input type='number' min='0' step='0.01' class='form-control' name='jml_jantan' required>
                        <span class='input-group-addon'>
                            Gram
                        </span></td></tr>
                      <tr><th width='120px' scope='row'>Betina</th>    <td class='input-group'><input type='number' min='0' step='0.01' class='form-control' name='jml_betina' required>
                        <span class='input-group-addon'>
                            Gram
                        </span></td></tr>
                    </tbody>
                  ...
                  <div><h3><u><b> <font color='blue'>Uniformity</font><b></u></h3></div>
                    ...
                    <tbody>
                      <input type='hidden' name='id_jadwal' value='".$this->uri->segment(3)."'>
                      <tr><th width='120px' scope='row'>Jantan</th>    <td class='input-group'><input type='number' min='0' step='0.01' class='form-control' name='uniform_jantan' required>
                        <span class='input-group-addon'>
                            <i class='fa fa-percent' aria-hidden='true'></i>
                        </span></td></tr>
                      <tr><th width='120px' scope='row'>Betina</th>    <td class='input-group'><input type='number' min='0' step='0.01' class='form-control' name='uniform_betina' required>
                        <span class='input-group-addon'>
                            <i class='fa fa-percent' aria-hidden='true'></i>
                        </span></td></tr>
                    </tbody>
