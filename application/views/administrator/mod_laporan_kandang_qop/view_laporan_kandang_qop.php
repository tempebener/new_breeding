...
<!-- <div class="col-xs-12"> -->
      ...
      <div class="box-body"><form method="get" action="<?php echo base_url();?>laporan_kandang">
        ...
        <thead>
          ...
          <tr bgcolor='#00c0ef'>
            ...
            <?php $sql = "select * from tb_chickin a join tb_kandang b on a.id_kandang = b.id_kandang where status_chickin = 1 ORDER BY a.id_kandang ASC";
                $aa=$this->db->query($sql)->result();
                foreach($aa as $a){
            ?>
  ...
  <div class="box table-responsive padding">
    <div class="box-body">
      <div class="box-body"><form method="get" action="<?php echo base_url();?>laporan_kandang">
    <p>Male</p>
        <table id='example1b' class='table table-bordered table-striped table-condensed'>
        <thead>
