...
<html>
  <head>
    ...
    <title>Selamat Datang Di Aplikasi Breeding </title>
    ...
    <!-- Added by Bayu -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/css/custom.min.css"/>
    <link rel="stylesheet" href="<?= base_url() ?>/asset/fontawesome-5-10/css/all.css"/>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#company').change(function(){
          ...
          $.ajax({
            type:"POST",
            url:"<?php echo site_url('combobox/plant'); ?>",
        ...
        $('#plant').change(function(){
          ...
          $.ajax({
            type:"POST",
            url:"<?php echo site_url('combobox/kandang'); ?>",
            data:"plant_id="+plant_id,
            success: function(response){
              $('#kandang').html(response);
            }
          })
        })

        // $('#kandang').change(function(){
        //   var kandang_id = $(this).val();
        //   $.ajax({
        //     type:"POST",
        //     url:"<?php echo site_url('combobox/kandang'); ?>",
        //     data:"kat_id="+kandang_id,
        //     success: function(response){
        //       $('#subkategori').html(response);
        //     }
        //   })
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <img class='pull-left' style='width:40px; margin-right:10px; border:1px solid #e3e3e3' src='<?php echo base_url()."asset/images/$row[logo]"; ?>'>
      <h3 style='margin:0px;'><b><?php echo $row['nama_perusahaan'] ?></b></h3>
      <p style='color:#000'><?php echo "$row[alamat_perusahaan] $row[kode_pos]"; ?></p>
    </div>
...
jQuery(".select2").select2();
    ...
    <script type="text/javascript">
      $("#multiplied1,#multiplied2,#multiplied3,#multiplied4").keyup(function() {
          var val1 = $('#multiplied1').val(); 
          var val2 = $('#multiplied2').val(); 
          var val3 = $('#multiplied3').val(); 
          var val4 = $('#multiplied4').val(); 
          var plus = Number(val1) + Number(val2) + Number(val3) + Number(val4);
          if ( val1 != "" && val2 != "" && val3 != "" && val4 != "" ) {
             $('#multipliedresult').val(plus);
          }
      });
      $("#plus1,#plus2,#plus3,#plus4").keyup(function() {
          var val1 = $('#plus1').val(); 
          var val2 = $('#plus2').val(); 
          var val3 = $('#plus3').val(); 
          var val4 = $('#plus4').val(); 
      ...
      $(".plus5,.plus6").keyup(function() {
          var val1 = $('.plus5').val(); 
          var val2 = $('.plus6').val();
          var plus = Number(val1) + Number(val2);
          if ( val1 != "" && val2 != "" ) {
             $('.plusresult2').val(plus);
          }
      });
      $("#multiplied1,#multiplied2,#multiplied3,#multiplied4,#plus1,#plus2,#plus3,#plus4").keyup(function() {
          var val1 = $('#multiplied1').val(); 
          var val2 = $('#multiplied2').val(); 
          var val3 = $('#multiplied3').val(); 
          var val4 = $('#multiplied4').val(); 
          ...
          var val7 = $('#plus3').val(); 
          var val8 = $('#plus4').val(); 
          var plus = Number(val1) + Number(val2) + Number(val3) + Number(val4) + Number(val5) + Number(val6) + Number(val7) + Number(val8);
          if ( val1 != "" && val2 != "" && val3 != "" && val4 != "" && val5 != "" && val6 != "" && val7 != "" && val8 != "" ) {
             $('#totalresult').val(plus);
          }
      });
      // Tax Percent from Rates
      $("#multipliedresult,#percentage").keyup(function() {
          var val1 = $('#multipliedresult').val();
          var val2 = $('#percentage').val();
          var kali = Number(val1) * Number(val2/100);
          if ( val1 != "" && val2 != "" ) {
             $('#percentageresult').val(kali);
          }
      });
    </script>
