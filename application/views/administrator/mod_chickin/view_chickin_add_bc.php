    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-6 no-border'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>No Chickin</th>    <td><input type='text' class='form-control' placeholder='Automaticly Generate Code' name='a' autocomplete='off' readonly required></td></tr>
                    <tr><th scope='row'>Unit Bisnis</th>    <td><select class='select-css form-control' name='m' id='unit_bisnis' required>
                                                            <option value=''>- Pilih -</option>";
                                                            foreach ($unit_bisnis as $r) {
                                                                echo "<option value='$r[id_unit_bisnis]'>$r[nama_unit_bisnis] ($r[kode_unit_bisnis])</option>";
                                                            }
                                                        echo "</select></td></tr>
                    <tr><th scope='row'>Perusahaan</th>    <td><select class='select-css form-control' name='e' id='company' required>
                                                            <option value=''>- Pilih -</option>";
                                                            foreach ($perusahaan as $r) {
                                                                echo "<option value='$r[id_perusahaan]'>$r[nama_perusahaan]</option>";
                                                            }
                                                        echo "</select></td></tr>
                    <tr><th scope='row'>Plant</th>    <td><select class='select-css form-control' name='g' id='plant' required>
                                                                <option value=''>- Pilih -</option>
                                                              </select></td></tr>
                    <tr><th scope='row'>Kandang</th>    <td><select class='select-css form-control' name='h' id='kandang' required>
                                                                <option value=''>- Pilih -</option>
                                                              </select></td></tr>
                    <tr><th scope='row'>Strain</th>    <td><select class='select-css form-control' name='j' id='strain' required>
                                                            <option value=''>- Pilih -</option>";
                                                            foreach ($strain as $r) {
                ...
                <div class='col-md-6 no-border'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Tanggal Chickin</th>    <td><input type='date' class='form-control' autocomplete='off' name='f' required></td></tr>
                    <tr><th scope='row'>Jumlah Betina</th>    <td><input type='text' class='form-control' autocomplete='off' name='b' required ></td></tr>
                    <tr><th width='150px' scope='row'>Jumlah Jantan</th>    <td><input type='text' class='form-control' autocomplete='off' name='c' required ></td></tr>
                    <tr><th scope='row'>Umur</th>    <td><input type='text' class='form-control' autocomplete='off' name='i' placeholder='Misal (hari): 365' required ></td></tr>
                    <tr class='hidden'><th scope='row'>Periode</th>    <td><input type='text' class='form-control' autocomplete='off' name='l' required ></td></tr>
                    <tr><th scope='row'>Asal DOC</th>    <td><select class='select-css form-control' name='n' id='supplier' required>
                                                            <option value=''>- Pilih -</option>";
